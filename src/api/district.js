export default function (req, res) {
    ...
    if(isNaN(req.query.year) || req.query.year < 2009 || req.query.year > 2020 || isNaN(req.query.countyId))return res.sendStatus(400);
    ...
    if(req.query.countyId != 0)city = ' and districts.city=' + req.query.countyId;
